...
def main():
    ...
    # Set Console title
    set_console_title("Nonamed Nuker V1 | Made by Nonamed#0001 | Menu")
 ...
 __    __                                                              __        __    __            __                           
/  \  /  |                                                            /  |      /  \  /  |          /  |                          
$$  \ $$ |  ______   _______    ______   _____  ____    ______    ____$$ |      $$  \ $$ | __    __ $$ |   __   ______    ______  
$$$  \$$ | /      \ /       \  /      \ /     \/    \  /      \  /    $$ |      $$$  \$$ |/  |  /  |$$ |  /  | /      \  /      \ 
$$$$  $$ |/$$$$$$  |$$$$$$$  | $$$$$$  |$$$$$$ $$$$  |/$$$$$$  |/$$$$$$$ |      $$$$  $$ |$$ |  $$ |$$ |_/$$/ /$$$$$$  |/$$$$$$  |
$$ $$ $$ |$$ |  $$ |$$ |  $$ | /    $$ |$$ | $$ | $$ |$$    $$ |$$ |  $$ |      $$ $$ $$ |$$ |  $$ |$$   $$<  $$    $$ |$$ |  $$/ 
$$ |$$$$ |$$ \__$$ |$$ |  $$ |/$$$$$$$ |$$ | $$ | $$ |$$$$$$$$/ $$ \__$$ |      $$ |$$$$ |$$ \__$$ |$$$$$$  \ $$$$$$$$/ $$ |      
...
$$/   $$/  $$$$$$/  $$/   $$/  $$$$$$$/ $$/  $$/  $$/  $$$$$$$/  $$$$$$$/       $$/   $$/  $$$$$$/  $$/   $$/  $$$$$$$/ $$/   V1.0                                                                                                                                
                        ...
                        ╔═════════════════════════╗         ╔═════════════════════════╗
                        ║   discord.gg/botnet     ║         ║   discord.gg/botnet     ║
                     ╔═══════════════════════════════╗   ╔═══════════════════════════════╗
    ...
    info = f"""{Fore.LIGHTCYAN_EX}\t\t\t\t\t  [+] Made by Nonamed#0001 [+]"""
    for x in info:
        time.sleep(0.0001)
        sys.stdout.write(x)
        sys.stdout.flush()
...
# ========================================================================================================================================================= #
    ...
    if choice == "1":
        ...
        message = "@here Nuked by discord.gg/botnet"
...
def socials():
    ...
    # Set Console title
    set_console_title("Nuker V1 | Made by Nonamed | Socials")

    banner = f"""
 __    __                                                              __ 
|  \  |  \                                                            |  \
| $$\ | $$  ______   _______    ______   ______ ____    ______    ____| $$
| $$$\| $$ /      \ |       \  |      \ |      \    \  /      \  /      $$
| $$$$\ $$|  $$$$$$\| $$$$$$$\  \$$$$$$\| $$$$$$\$$$$\|  $$$$$$\|  $$$$$$$
| $$\$$ $$| $$  | $$| $$  | $$ /      $$| $$ | $$ | $$| $$    $$| $$  | $$
| $$ \$$$$| $$__/ $$| $$  | $$|  $$$$$$$| $$ | $$ | $$| $$$$$$$$| $$__| $$
